...
//  FileManger_Load
//
//  Created by Gbenga Abayomi on 26/03/2023.
//
...
class LocalFileManager {
    ...
    func deleteImage(name: String) -> String{
        ...
        do {
            ...
            return "file not successfully deleted. \(error)"
        }
    }
}
...
//        print("file 1 \(directory) ")
//        print("file 1 \(directory2) ")
//        print("file 1 \(directory3) ")
